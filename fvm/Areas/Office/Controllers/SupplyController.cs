...
namespace fvm.Areas.Office.Controllers
{
    public class SupplyController : Controller
    {
        ...
        // GET: Office/Supply/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Office/Supply/Create
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Create([Bind(Include = "SupplyID,SupplyDesignator,SupplyCategory,SupplyCategorySub,SupplyItemNumber,SupplyModelNumber,SupplySerialNumber,SupplyVariety,SupplyColor,SupplySize,SupplyDimensions,SupplyDescription,SupplyCount,SupplyPack,SupplyOrderQuantity,SupplyUnitPriceString,SupplyTag,SupplyNote,SupplyURLAccess")] Supply supply)
        {
        ...
        // POST: Office/Supply/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SupplyID,SupplyDesignator,SupplyCategory,SupplyCategorySub,SupplyItemNumber,SupplyModelNumber,SupplySerialNumber,SupplyVariety,SupplyColor,SupplySize,SupplyDimensions,SupplyDescription,SupplyCount,SupplyPack,SupplyOrderQuantity,SupplyUnitPriceString,SupplyTag,SupplyNote,SupplyURLAccess")] Supply supply)
        {
            if (ModelState.IsValid)
            {
